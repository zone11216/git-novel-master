...
public class ApiRouterConsts {
     ...
     * 平台后台用户管理模块请求路径前缀
     */
    public static final String API_ADMIN_USER_URL_PREFIX = API_ADMIN_URL_PREFIX + USER_URL_PREFIX;

    /**
     * 平台后台角色管理模块请求路径前缀
     */
    public static final String API_ADMIN_ROLE_URL_PREFIX = API_ADMIN_URL_PREFIX + "/role";

    /**
     * 平台后台菜单管理模块请求路径前缀
     */
    public static final String API_ADMIN_MENU_URL_PREFIX = API_ADMIN_URL_PREFIX + "/menu";
